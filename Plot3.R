...
plot(household_power_consumption_subset$datetime, household_power_consumption_subset$Sub_metering_1, type = "l", xlab = "", ylab = "Energy sub metering")

points(household_power_consumption_subset$datetime, household_power_consumption_subset$Sub_metering_2, type = "l", col = "red")

points(household_power_consumption_subset$datetime, household_power_consumption_subset$Sub_metering_3, type = "l", col = "blue")
